...
function render(){
  ...
  document.getElementById('footer').innerHTML = \`
    ...
    <p>Version notes sourced from the <a href="\${DATA.meta.authoritative_source}" target="_blank" rel="noopener">Polestar 4 UK manual</a>.
       Unofficial; not affiliated with Polestar.</p>\`;
}
render();
</script>
</body>
