...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .entry::before{
    content:"";position:absolute;left:-35px;top:6px;width:13px;height:13px;border-radius:50%;
...
<div class="wrap">
  <header class="site">
    ...
    <p class="lede">When the next over-the-air update is likely to land, how often they arrive, and what each one changed. Version notes from
      <a href="https://www.polestar.com/us/manual/polestar-4/2025/software-updates/" target="_blank" rel="noopener">Polestar's manual</a>.</p>
  </header>
